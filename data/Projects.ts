const projects: ProjectsProps[] = [
  {
    ...
    name: "!answer",
    descr:
      "!answer is a discord bot that leverages state of the art artificial intelligence to serve your users in your discord guild. You can give the bot context paragraphs, from which the bot will reply to any questions of users.",
  },
